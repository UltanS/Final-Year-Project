...
class RepStateMachine:
    """
    Tracks repitition phases using vertical motion and lockout conditions

    The state machine can be re used for different lifts by using lift
